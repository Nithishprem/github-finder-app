...
function User() {
    ...
    return (
        <>
            <div className='w-full mx-auto lg:w-10/12 xl:10/12'>
                <div className='mb-4'>
                ...
                lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        shadow-md bg-base-100 stats">
                            ...
                            {blog && 
                                <div className="stat">
                                    <div className="stat-title text-md">Blog
                                    </div>
                                    <div className="stat-value text-lg">
                            ...
                            {twitter_username && 
                                <div className="stat">
                                    ...
                                    <div className="stat-value text-lg">
                                    <a href={`https://twitter.com/${blog}`} target="_blank" 
                                rel='noreferrer' 
                                className=''>{twitter_username}</a>
                                    </div>
                                </div>}
                        </div>
                    </div>
                ...
                <div className="w-full py-5 mb-6 rounded-lg shadow md bg-base-100 stats">
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                            <FaUsers className='text-3xl md:5-xl'/>
                        </div>
                    ...
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                            <FaUserFriends className='text-3xl md:5-xl'/>
                        </div>
                    ...
                    <div className="stat">
                        <div className="stat-figure text-secondary">
                            <FaCodepen className='text-3xl md:5-xl'/>
                        </div>
